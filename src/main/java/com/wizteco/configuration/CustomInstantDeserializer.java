...
public class CustomInstantDeserializer<T extends Temporal>
  ...
  public static final CustomInstantDeserializer<OffsetDateTime> OFFSET_DATE_TIME = new CustomInstantDeserializer<OffsetDateTime>(
      ...
      new CustomFunction<TemporalAccessor, OffsetDateTime>() {
        
        public OffsetDateTime apply(TemporalAccessor temporalAccessor) {
          return OffsetDateTime.from(temporalAccessor);
        }
      },
      new CustomFunction<FromIntegerArguments, OffsetDateTime>() {
        
        public OffsetDateTime apply(FromIntegerArguments a) {
          return OffsetDateTime.ofInstant(Instant.ofEpochMilli(a.value), a.zoneId);
        }
      },
      new CustomFunction<FromDecimalArguments, OffsetDateTime>() {
      ...
      new CustomBiFunction<OffsetDateTime, ZoneId, OffsetDateTime>() {
  ...
  public static final CustomInstantDeserializer<ZonedDateTime> ZONED_DATE_TIME = new CustomInstantDeserializer<ZonedDateTime>(
      ...
      new CustomBiFunction<ZonedDateTime, ZoneId, ZonedDateTime>() {
  ...
  protected  final CustomFunction<FromIntegerArguments, T> fromMilliseconds;

  protected  final CustomFunction<FromDecimalArguments, T> fromNanoseconds;

  protected  final CustomFunction<TemporalAccessor, T> parsedToValue;

  protected  final CustomBiFunction<T, ZoneId, T> adjust;

  protected CustomInstantDeserializer(Class<T> supportedType,
                    DateTimeFormatter parser,
                    CustomFunction<TemporalAccessor, T> parsedToValue,
                    CustomFunction<FromIntegerArguments, T> fromMilliseconds,
                    CustomFunction<FromDecimalArguments, T> fromNanoseconds,
                    CustomBiFunction<T, ZoneId, T> adjust) {
    super(supportedType, parser);
    this.parsedToValue = parsedToValue;
    this.fromMilliseconds = fromMilliseconds;
    this.fromNanoseconds = fromNanoseconds;
    this.adjust = adjust == null ? new CustomBiFunction<T, ZoneId, T>() {
  ...
  private static class FromIntegerArguments implements Serializable{
	private static final long serialVersionUID = 1L;
  ...
  private static class FromDecimalArguments implements Serializable{
	private static final long serialVersionUID = 1L;
